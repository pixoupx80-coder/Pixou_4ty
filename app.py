...
def auto_restart():
    print("\n" + "═" * 50)
    print("وضع التشغيل التلقائي مفعل - البوت سيعمل 24/24")
    print("═" * 50)

    while True:
        try:
            STaRt_BoT()
            print("\nانتهى التشغيل... إعادة التشغيل خلال 5 ثواني")
            time.sleep(5)
            ...
            print("\n" + "!" * 50)
            print("تعطل البوت! إعادة التشغيل التلقائي...")
            print(f"الخطأ: {e}")
            traceback.print_exc()
            print("!" * 50)
            time.sleep(5)
